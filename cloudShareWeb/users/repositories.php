            ...
            <div class="side-nav fixed" id="nav-mobile">
                <div class="logo center" style="max-height:200px"></div>
                    ...
                    <li class="bold wave-effects wave-teal center"><h5>Main Menu</h5></li>
                      <li class="bold active"><a href="" class="waves-effect waves-teal">My Repositories</a></li>
                      <li class="bold"><a href="shared.php" class="waves-effect waves-teal">Shared With Me</a></li>
                    ...
                    <div class="col s12 m6 l4">
                      <div class="card blue-grey darken-1">
                        ...
                        <div class="card-action">
                          <a href="view_repository.php?repo='.$row['id'].'">View Repository</a>
                        </div>
                      </div>
                    </div>
